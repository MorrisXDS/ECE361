...
all: server client
server: server/server.o message/message.o server/session.o
	$(CC) $(CFLAGS) $(THD) server/server.o message/message.o server/session.o -o server/server
client: client/client.o message/message.o
	$(CC) $(CFLAGS) $(THD) client/client.o message/message.o -o client/client
server.o: server/server.c  server/server.h message/message.h server/session.h

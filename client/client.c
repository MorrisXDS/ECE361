...
int main(int argc, char* argv[]){
    ...
    //compare the argument(3) with the server address amd argument(4) with the port number
//    if (strcmp(arguments[3], "128.100.13.252") == 0) printf("address correct\n");
//    if (strcmp(arguments[4], "5000") == 0) printf("port correct\n");
